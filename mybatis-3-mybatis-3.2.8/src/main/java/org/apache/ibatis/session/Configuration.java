...
public class Configuration {
  ...
  protected Properties variables = new Properties();//properties配置里的属性将被存放在Configuration的variables变量里
  ...
  //Mybatis的官方手册建议通过Mapper对象访问mybatis
  //eg: UserMapper userMapper =sqlSession.getMapper(UserMapper.class); 
  //表明上Mapper对象是在SqlSession中创建的
  //实际上Mapper对象是在MapperRegistry中创建的
